...
import { Button, Card, Modal, Portal, Text, PaperProvider } from "react-native-paper";
	...
	return (
		<Card>
			...
			<Card.Actions>
				...
				{sms.user === "user" ? (
					<Button labelStyle={{ fontSize: 11 }} mode="elevated" buttonColor="#E3E3E3" icon="tools" onPress={showModal}>
						Cambiar categoría
					</Button>
				) : (
					""
