import { View, Text, Pressable, Image, SafeAreaView, PermissionsAndroid, Platform } from "react-native";
	...
	return (
		...
		>
			...
			<SafeAreaView className="flex-1 mx-5 my-12 justify-between">
				<View>
					<Text className="text-center text-white font-bold text-3xl">Transfermovil-Contabilidad</Text>
				...
				<View>
					<CustomButton onPress={() => router.push("/list-view")} title="Empecemos" />
				</View>
